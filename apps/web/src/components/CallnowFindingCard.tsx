...
export const CallnowFindingCard: React.FC<FindingCardProps> = ({
  ...
  const [isInstalledVerified, setIsInstalledVerified] = React.useState(initialIsPushed)
  const [isNumberVerified, setIsNumberVerified] = React.useState(initialIsPushed)
  const [isMobileVerified, setIsMobileVerified] = React.useState(initialIsPushed)
  const [isValidPhoneVerified, setIsValidPhoneVerified] = React.useState(initialIsPushed)
  const [isValidEmailVerified, setIsValidEmailVerified] = React.useState(initialIsPushed)
  const [isLinksVerified, setIsLinksVerified] = React.useState(initialIsPushed)
              ...
              <div className="flex flex-col gap-3 pl-4 border-l border-slate-100 dark:border-slate-700/50">
                <label className="flex items-center gap-2 group/cb">
                  <input
                    ...
                    onChange={(e) => {
                      if (isLocked) return
                      setIsInstalledVerified(e.target.checked)
                    }}
                ...
                <label className="flex items-center gap-2 group/cb">
                  <input
                    ...
                    onChange={(e) => {
                      if (isLocked) return
                      setIsNumberVerified(e.target.checked)
                    }}
                    className="w-3 h-3 text-accent border-slate-300 dark:border-slate-600 dark:bg-[#131d22] rounded focus:ring-accent accent-accent cursor-pointer transition-all"
                  />
                  <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest group-hover/cb:text-slate-900 dark:group-hover/cb:text-slate-200 transition-colors cursor-pointer">
                ...
                <label className="flex items-center gap-2 group/cb">
                  <input
                    ...
                    onChange={(e) => {
                      if (isLocked) return
                      setIsValidPhoneVerified(e.target.checked)
                    }}
                    className="w-3 h-3 text-accent border-slate-300 dark:border-slate-600 dark:bg-[#131d22] rounded focus:ring-accent accent-accent cursor-pointer transition-all"
                  />
                  <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest group-hover/cb:text-slate-900 dark:group-hover/cb:text-slate-200 transition-colors cursor-pointer">
                ...
                <label className="flex items-center gap-2 group/cb">
                  <input
                    ...
                    onChange={(e) => {
                      if (isLocked) return
                      setIsValidEmailVerified(e.target.checked)
                    }}
                    className="w-3 h-3 text-accent border-slate-300 dark:border-slate-600 dark:bg-[#131d22] rounded focus:ring-accent accent-accent cursor-pointer transition-all"
                  />
                  <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest group-hover/cb:text-slate-900 dark:group-hover/cb:text-slate-200 transition-colors cursor-pointer">
                ...
                <label className="flex items-center gap-2 group/cb">
                  <input
                    ...
                    onChange={(e) => {
                      if (isLocked) return
                      setIsLinksVerified(e.target.checked)
                    }}
                    className="w-3 h-3 text-accent border-slate-300 dark:border-slate-600 dark:bg-[#131d22] rounded focus:ring-accent accent-accent cursor-pointer transition-all"
                  />
                  <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest group-hover/cb:text-slate-900 dark:group-hover/cb:text-slate-200 transition-colors cursor-pointer">
